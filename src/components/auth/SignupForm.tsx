...
import { normalizeAuthError, signup } from "@/lib/auth/auth.api";
import type { AuthErrorVM, FieldErrorsVM } from "@/lib/auth/auth.types";

interface SignupFormProps {
  onSuccess: (dto: Awaited<ReturnType<typeof signup>>) => void;
...
export function SignupForm({ onSuccess, onError }: SignupFormProps) {
  ...
  const [values, setValues] = useState<SignupCommand>({ email: "", password: "" });
